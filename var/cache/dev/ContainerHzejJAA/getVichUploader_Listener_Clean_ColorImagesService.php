 ...
 */
class getVichUploader_Listener_Clean_ColorImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.color_images' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.color_images'])) {
            return $container->privates['vich_uploader.listener.clean.color_images'];
        }

        return $container->privates['vich_uploader.listener.clean.color_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('color_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}

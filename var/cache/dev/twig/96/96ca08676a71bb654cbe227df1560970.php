...
class __TwigTemplate_296eca0a12e58aa66147906b7e851e95 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "firstname", [], "any", false, false, false, 12), 'row', ["attr" => ["class" => "form-control mb-3"]]);
        echo "
\t\t\t";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "lastname", [], "any", false, false, false, 13), 'row', ["attr" => ["class" => "form-control mb-3"]]);
        echo "
\t\t</div>
\t\t<div class=\"col-md-6 mb-3\">
\t\t\t";
...
\t\t\t";
        // line 20
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 20, $this->source); })()), "content", [], "any", false, false, false, 20), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
\t\t</div>
\t</div>
...
";
    ...
    {
        return array (  131 => 26,  122 => 20,  116 => 17,  112 => 16,  106 => 13,  102 => 12,  96 => 9,  92 => 8,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
\t\t\t{{ form_row(form.lastname, {'attr': {'class': 'form-control mb-3'}}) }}
\t\t</div>
\t\t<div class=\"col-md-6 mb-3\">
...
\t{{ form_end(form) }}
{% endblock %}
", "contact/index.html.twig", "/Users/emma/ecf-garage-vigneron-emma/templates/contact/index.html.twig");
    }
}
